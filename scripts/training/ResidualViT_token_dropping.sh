...
PATCH_DROP_RATE=0.85
PATCH_DROP_MODE=center
NUM_RES_LAYERS=1
...
MODEL_PARAMS="--model $STUDENT \
            ...
            --force-patch-dropout $PATCH_DROP_RATE \
            --force-inference-patch-dropout $PATCH_DROP_RATE \
            --inference-patch-dropout-mode $PATCH_DROP_MODE \
...
#---------------------------------- LOGGING -----------------------------------
FOLDER=token_dropping
EXP=${FOLDER}/${STUDENT}__p_${PATCH_DROP_RATE}
