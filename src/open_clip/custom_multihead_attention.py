...
class CustomMultiheadAttention(nn.MultiheadAttention):
    ...
    def forward(
            ...
            attn_size: Optional[Tensor] = None) -> Tuple[Tensor, Optional[Tensor]]:
        r"""
    Args:
    ...
    Outputs:
        ...
        if not self._qkv_same_embed_dim:
            attn_output, attn_output_weights, k = F.multi_head_attention_forward(
...
def multi_head_attention_forward(
    ...
    average_attn_weights: bool = True,
    is_causal: bool = False,
    attn_size: Optional[Tensor] = None,
    ...
    if need_weights:
        ...
        if attn_size is not None:
            ...
            attn_output_weights = attn_output_weights + attn_size.log()[:,None, None, :, 0]
            attn_output_weights = attn_output_weights.view(bsz * num_heads, tgt_len, src_len)
        ...
        return attn_output, attn_output_weights, k.view(bsz, num_heads, src_len, head_dim)
    else:
